         ...
         <div class="row">
            <div class="col-md-4">
               <div class="account-usd text-left">
                  <ul>
                     <li>
                        <a href="account.html">My Account <i class="fa fa-angle-down"></i></a>
                     ...
                     <li class="language">
                        <a href="#"><img src="<?= Yii::$app->homeUrl?>img/icon/eng.png" alt="">English <i class="fa fa-angle-down"></i></a>
                        <ul class="submenu-mainmenu">
                           <li><a href="#"><img src="<?= Yii::$app->homeUrl?>img/icon/eng.jpg" alt="">English</a></li>
                           <li><a href="#"><img src="<?= Yii::$app->homeUrl?>img/icon/ger.jpg" alt="">German</a></li>
                           <li><a href="#"><img src="<?= Yii::$app->homeUrl?>img/icon/fren.jpg" alt="">French</a></li>
                        </ul>
                     </li>
                  </ul>
               </div>
               ...
               <div class="top-right">
                  <div class="top-login-cart">
                     <ul>
                        ...
                        <li>
                           <a href="cart.html"><img src="<?= Yii::$app->homeUrl?>img/icon/cart_red.png" alt="cart">Cart (3)</a>
                           <ul class="submenu-mainmenu">
                              <li class="single-cart-item clearfix">
                                 <span class="cart-img">
                                 <a href="#"><img src="<?= Yii::$app->homeUrl?>img/cart/1.jpg" alt=""></a>
                                 </span>
                              ...
                              <li class="single-cart-item clearfix">
                                 <span class="cart-img">
                                 <a href="#"><img src="<?= Yii::$app->homeUrl?>img/cart/2.jpg" alt=""></a>
                                 </span>
                                 <span class="cart-info">
                              ...
                              <li class="single-cart-item clearfix">
                                 <span class="cart-img">
                                 <a href="#"><img src="<?= Yii::$app->homeUrl?>img/cart/3.jpg" alt=""></a>
                                 </span>
                                 <span class="cart-info">
         ...
         <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
               <div class="search-box">
                  <img src="<?= Yii::$app->homeUrl?>img/icon/search.png" alt="">
                  <form action="#">
         ...
         <div class="mainmenu">
            <ul>
               ...
               <li>
                  ...
                  <ul class="submenu-mainmenu">
                     <li>
                        <a href="parallax-one.html"><i class="fa fa-circle"></i>Sliders<i class="fa fa-angle-right"></i></a>
                     ...
                     <li>
                        <a href="menu-default.html"><i class="fa fa-circle"></i>Menu Style<i class="fa fa-angle-right"></i></a>
                        <ul class="sub-submenu-mainmenu">
                     ...
                     <li>
                        <a href="title-one.html"><i class="fa fa-circle"></i>Page Title<i class="fa fa-angle-right"></i></a>
                        <ul class="sub-submenu-mainmenu">
                     ...
                     <li>
                        <a href="index-4.html"><i class="fa fa-circle"></i>Footer<i class="fa fa-angle-right right"></i></a>
                        <ul class="sub-submenu-mainmenu">
               ...
               <li class="shop">
                  <a href="shop-grid-right-sidebar.html">Shop</a>
                  <ul class="submenu-mainmenu">
               ...
               <li><a href="#">Men</a></li>
               <li>
                  <a href="#">Women<span><img src="<?= Yii::$app->homeUrl?>img/icon/hot.png" alt=""></span></a>
                  <div class="mega-menu">
                     <span>
               ...
               <div class="mobile-menu">
                  <nav id="dropdown">
                     <ul>
                        ...
                        <li>
                           <a href="slider-one.html">Features</a>
                           <ul>
                        ...
                        <li>
                           <a href="shortcode-blog.html">shortcode</a>
                           <ul>
