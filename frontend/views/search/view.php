...
<div class="col-md-8 search image_slider">
	<div class="col-md-11 col-md-offset-1">
		<?php $form = ActiveForm::begin([
			'action'  =>  Url::to(['/tim-kiem-website.htm','keySearch'=>$model->keySearch]),
			'action' => ['search/view'],
			'method'  => 'get',
		...
		<div class="input-group col-md-10" style="margin: 15px 0">
			<?= Html::textInput('keySearch', ($keySearch!='')?$keySearch: "", ['class' => 'textSearch form-control',"placeholder"=>" Tìm kiếm ","style"=>"width:80%"]) ?>
