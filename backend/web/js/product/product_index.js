var Product =
{
    ...
    saveGuarantees: function() {
        ...
        var saveGuarantees = $('.saveGuarantees');
        saveGuarantees.each(function() {
            $(this).click(function() {

                var box = $(this).parent('.proUpdate');
                var url = $(this).data('url');
                var guarantee = $('#guarantee'+$(this).data('id')).val();
                // console.log(box);
                if (guarantee=='') {
                    alert('Bạn phải nhập thời gian bảo hành')
                }else{
    ...
    changePrice: function() {
        // LUU VAO CSDL SU DUNG AJAX
        var savePrices = $('.savePrices');
        savePrices.each(function() {
            $(this).click(function() {

                var box = $(this).parent('.proUpdate');
                var url = $(this).data('url');
                var price_val = $('#price'+$(this).data('id')).val();
                // console.log(url);
                // console.log(price);
