...
<nav class="navbar navbar-default navbar-static-top m-b-0">
   <div class="navbar-header">
      ...
      <div class="top-left-part"><a class="logo" href="index.html"><b><img src="<?= Yii::$app->homeUrl?>plugins/images/eliteadmin-logo.png" alt="home" /></b><span class="hidden-xs"><strong>elite</strong>hospital</span></a></div>
      ...
      <ul class="nav navbar-top-links navbar-right pull-right">
         ...
         <!-- /.dropdown -->
         <li class="dropdown">
            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="<?= Yii::$app->homeUrl?>plugins/images/users/d1.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Dr. Steave</b> </a>
