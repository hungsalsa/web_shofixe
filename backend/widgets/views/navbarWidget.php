...
<nav class="navbar navbar-default navbar-static-top m-b-0">
   <div class="navbar-header">
      <a class="navbar-toggle hidden-sm hidden-md hidden-lg col-xs-3" href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
      <div class="top-left-part pull-left"><a class="logo" href="<?= Yii::$app->homeUrl ?>"><b><img src="<?= Yii::$app->homeUrl?>plugins/images/eliteadmin-logo.png" alt="home" /></b><span class="hidden-xs"><strong>Quản trị</strong> Website</span></a></div>
      ...
      <ul class="nav navbar-top-links navbar-right pull-left" style="margin-left: 40px">
         <li><?= Html::a('<i class="fa fa-map-marker" aria-hidden="true"></i> Tạo Sitemap', Yii::$app->homeUrl.'site/xml') ?></li>
      </ul>
      <ul class="nav navbar-top-links navbar-right pull-right">
        ...
        <!--  <li class="dropdown">
         ...
         <!-- /.dropdown -->
         <li class="dropdown">
            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="<?= Yii::$app->homeUrl?>plugins/images/users/d1.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?= getUser()->username ?></b> </a>
