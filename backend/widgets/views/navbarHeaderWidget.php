<div class="navbar-default sidebar" role="navigation">
   <div class="sidebar-nav navbar-collapse slimscrollsidebar">
      <ul class="nav" id="side-menu">
         ...
         <li class="user-pro">
            <a href="#" class="waves-effect"><img src="<?= Yii::$app->homeUrl?>plugins/images/users/d1.jpg" alt="user-img" class="img-circle"> <span class="hide-menu">Dr. Steve Gection<span class="fa arrow"></span></span>
            </a>
         ...
         <!-- <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="icon-envelope p-r-10"></i> <span class="hide-menu"> Mailbox <span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">6</span></span></a>
            <ul class="nav nav-second-level">
         ...
         <li>
            ...
            <ul class="nav nav-second-level">
               <li> <a href="<?= Yii::$app->homeUrl ?>quantri/group">Nhóm</a> </li>
               <li> <a href="<?= Yii::$app->homeUrl ?>quantri/manufactures">Nhà sản xuất</a> </li>
               <li> <a href="<?= Yii::$app->homeUrl ?>quantri/models">Loại xe</a> </li>
               <li> <a href="<?= Yii::$app->homeUrl ?>quantri/seourl">Seo đường dẫn</a> </li>
            </ul>
         </li>
         <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-user-md p-r-10"></i> <span class="hide-menu"> Sản phẩm <span class="fa arrow"></span></span></a>
            <ul class="nav nav-second-level">
               <li> <a href="<?= Yii::$app->homeUrl ?>quantri/productcategory">Danh mục sản phẩm</a> </li>
               <li> <a href="<?= Yii::$app->homeUrl ?>quantri/product">Sản phẩm</a> </li>
               <li> <a href="<?= Yii::$app->homeUrl ?>quantri/producttype">Loại sản phẩm</a> </li>
         ...
         <li>
            <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-inr p-r-10"></i> <span class="hide-menu"> Payments <span class="fa arrow"></span></span></a>
            <ul class="nav nav-second-level">
         ...
         <li>
            <a href="#" class="waves-effect"><i class="ti-files fa-fw
            ...
            <ul class="nav nav-second-level">
               ...
               <li>
                  <a href="javascript:void(0)" class="waves-effect">Email Templates
