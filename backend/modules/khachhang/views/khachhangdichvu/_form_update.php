<?php
    ...
    $dichvunew = new KhachhangDichvuList();
    // $dataprice =[];
?>
            ...
            <?= $form->field($model, 'time_to',['options'=>['class'=>'col-md-2']])->widget(TimePicker::classname(), [
                ...
                <?= $form->field($model, 'sophieu',['options'=>['class'=>'col-md-2']])->widget(Select2::classname(), 
                    ...
                    <?= $form->field($model, 'status',['options'=>['class'=>'col-md-2']])->widget(Select2::classname(), 
                        ...
                        ?>
                        <div class="clearfix"></div>
                        <?= $form->field($model, "cuahang_id",['options'=>['class'=>'col-md-1']])->hiddenInput()->label(false);?>
                        <?= $form->field($model, "id_kh",['options'=>['class'=>'col-md-1']])->hiddenInput()->label(false);?>
                        <hr>
                        <div class="row">
                                ...
                                <?= $form->field($adddv, "quantity",['options'=>['class'=>'col-md-1']])->textInput(['type' => 'number','id'=>'dv_quantity','min'=>1]) ?>
                                            ...
                                            <?php   foreach ($modelsKhChitietDv as $key => $chitiet): ?>
                                                ...
                                                <tr class="dichvu_<?= $chitiet->id ?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($key != 0): ?>
                                                        <button type="button" class="btn btn-danger btn-outline btn-circle btn-lg m-r-5 deleteChitiet" data-url="<?= Yii::$app->getUrlManager()->createUrl(['/khachhang/khachhangdichvu/xoachitiet']) ?>" data-id="<?= $chitiet->id ?>"><i class="ti-trash"></i></button>

                                                        <?php endif ?>
                                                    </td>
                                                </tr>
                                                <tr class="Update_dichvu_<?= $chitiet->id ?> updateDichvu" style="display: none" data-url="<?= Yii::$app->getUrlManager()->createUrl(['/khachhang/khachhangdichvu/suachitiet']) ?>">
                                                    ...
                                                    <td>
                                                        <?= $form->field($chitiet, 'id_Pro_dv')->widget(Select2::classname(), 
                                                            [
                                                                'data' => $dataDichvu,
                                                                'options' => [
                                                                    'placeholder' => 'Chon một',
                                                                    'id'=>'cat-id'.$chitiet->id,
                                                                    'data-id' => $chitiet->id
                                                                ],
                                                                'pluginOptions' => [
                                                                    'allowClear' => true,
                                                    ...
                                                    <td>
                                                        ...
                                                        [
                                                            'value'=>$chitiet->price,
                                                            'data' => (isset($chitiet->danhsachdv)) ? $dichvunew->UpdatePhieuDV($chitiet->danhsachdv->id) :[],
                                                    ...
                                                    <td>
                                                        <?= $form->field($chitiet, "quantity")->textInput(['type' => 'number','id'=>'dv_quantity'.$chitiet->id,'data-id' => $chitiet->id])->label(false) ?>
                                                    </td>
...
$this->registerJsFile('@web/js/dichvu/updatechitiet.js', ['depends' => [\yii\web\JqueryAsset::class]] );
