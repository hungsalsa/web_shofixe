...
/**
 * ManufactureSearch represents the model behind the search form of `backend\modules\sanpham\models\Manufacture`.
 */
class ManufactureSearch extends Manufacture
{
    ...
    public function rules()
    {
        return [
            ...
            [['manuName', 'address', 'phone', 'note', 'status'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'manuName', $this->manuName])
