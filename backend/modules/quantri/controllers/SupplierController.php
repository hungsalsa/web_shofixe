...
use backend\modules\quantri\models\SupplierSearch;
...
class SupplierController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load($post = Yii::$app->request->post())) {
            $model->supName = ucwords($post['Supplier']['supName']);

            if ($post['Supplier']['address']!='') {
                $model->address = ucwords($post['Supplier']['address']);
            }
