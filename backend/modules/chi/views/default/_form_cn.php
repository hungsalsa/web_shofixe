                    ...
                    <div class="item panel panel-default"><!-- widgetBody -->
                        ...
                        <div class="panel-body" style="padding:0 2px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <?= $form->field($modelChitietchi, "[{$i}]motorbike")->widget(Select2::classname(), [
                                        'data' => $dataMotor,
                                        'options' => ['placeholder' => 'Tên khoản chi'],
                                        'language' => 'en',
                                        'pluginOptions' => [
                                            'allowClear' => true
                                        ],
                                    ])->label('<span>Cho xe</span>'.Html::a('<i class="fa fa-plus-circle"></i>', ['/quantri/motorbike/create'], ['title' => 'Thêm xe sử dụng', 'style' => 'margin-left:10px','target' => '_blank','data' => ['pjax' => 0]])) ?>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <?= $form->field($modelChitietchi, "[{$i}]bill_number")->widget(Select2::classname(), [
                                        'data' => $dataSophieu,
                                        'options' => ['placeholder' => 'Tên khoản chi'],
                                        'language' => 'en',
                                        'pluginOptions' => [
                                ...
                                <div class="col-sm-2">
                                    <?= $form->field($modelChitietchi, "[{$i}]employee_id")->widget(Select2::classname(), [
                                        'data' => $dataEmployee,
                                        'options' => ['placeholder' => 'Người đi mua'],
                                        'language' => 'en',
                                        'pluginOptions' => [
                                            'allowClear' => true
                                        ],
