 ...
 */
class ChitietchiController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Displays a single Chitietchi model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new Chitietchi model.
    ...
    /**
     * Updates an existing Chitietchi model.
    ...
    /**
     * Deletes an existing Chitietchi model.
    ...
    /**
     * Finds the Chitietchi model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Chitietchi the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Chitietchi::findOne($id)) !== null) {
            return $model;
        }
